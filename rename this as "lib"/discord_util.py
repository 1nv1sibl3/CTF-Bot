...
async def update_scoreboard(
    scoreboard_channel: Optional[discord.TextChannel],
    message: str,
    ...
    Notes:
        ...
        If scoreboard_channel is None, the function will return silently.
    """
    # Return early if scoreboard channel doesn't exist
    ...
    try:
        ...
        # Handle case where channel was deleted
        return
